...
Arduino + Pycharm system which records temperature data from a waterproof DS18B20 sensor, analyzing and graphing the collected measurments.

Skills:
- Arduino
- Serial Communication between Arduino and Pycharm
- Python
- Data visualization
- Sensor integration
...
### C++ To-Do List
Console application demonstrating file persistance and object-oriented design
