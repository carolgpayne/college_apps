...
def graph_position(projectile):
    plt.plot(projectile.x_points, projectile.y_points, label="Theoretical Trajectory")
...
def simulate_position(projectile):
    x_points, y_points, t_points = ps.simulate_projectile(projectile.v0, projectile.angle)
